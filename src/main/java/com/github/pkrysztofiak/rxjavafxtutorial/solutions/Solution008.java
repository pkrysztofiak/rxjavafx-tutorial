...
public class Solution008 extends Application {
	...
	public void start(Stage stage) throws Exception {
		...
		Observable.merge(decrementButtonClickedObservable.map(event -> -1), incrementButtonClickedObservable.map(event -> 1))
